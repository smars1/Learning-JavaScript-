...
mongoose.connect('mongodb+srv://<Account>:<>PassWord>@cluster0.3a9hre8.mongodb.net/Cluster0?retryWrites=true&w=majority');
...
// esta de ejecutara cuando nuestra app se ejecute con exito
app.listen(port, () =>{
